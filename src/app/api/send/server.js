...
app.use(cors({
  origin: [
    "http://localhost:3000",
    "https://shabanbujaportfolio.onrender.com",
    "https://banibuja.github.io",
    "https://shabanbuja.info",
    "https://www.shabanbuja.info"
  ],
...
//     bot.sendMessage(process.env.CHAT_ID, `📩 New message: ${msg}`);

//     // Respond back to the client
//     socket.emit('message', { sender: 'Bot', text: 'Faleminderit për mesazhin tuaj!' });
//   });
